...
})(["display:flex;flex-direction:column;align-items:center;justify-content:center;background-color:black;background-image:url(/boca.webp);min-height:600px;background-position:center center;background-size:cover;div{flex-grow:1;display:flex;align-items:center;justify-content:center;}.disclaimer{padding:16px;background-color:rgba(0,0,0,0.6);color:white;font-weight:bold;font-size:32px;border-radius:8px;}"]);

/***/ })

})
//# sourceMappingURL=index.js.445754be4407bd1bfda7.hot-update.js.map