...
})(["display:flex;flex-direction:column;align-items:center;justify-content:center;background-color:#FDD;.images{display:flex;max-width:1200px;overflow-x:scroll;a{display:inline-flex;position:relative;&:after{content:attr(data-text);position:absolute;bottom:0;margin:0;background-color:rgba(0,0,0,0.6);color:white;padding:8px 16px;opacity:0.2;transition:all ease 300ms;width:100%;}&:hover{&:after{opacity:1;}}}}img{object-fit:cover;}"]);

/***/ })

})
//# sourceMappingURL=index.js.ed1d57ff78417f6020d0.hot-update.js.map