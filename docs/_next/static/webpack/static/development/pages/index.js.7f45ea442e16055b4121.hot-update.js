...
})(["display:flex;flex-direction:column;align-items:center;justify-content:center;.images{display:flex;max-width:1200px;a{display:inline-flex;position:relative;&:after{content:attr(data-text);position:absolute;bottom:0;margin:0;min-height:50px;background-color:rgba(0,0,0,0.6);color:white;padding:8px 16px;opacity:0.2;transition:all ease 300ms;}&:hover{&:after{opacity:1;}}}}img{object-fit:cover;}"]);

/***/ })

})
//# sourceMappingURL=index.js.7f45ea442e16055b4121.hot-update.js.map