...
})(["display:flex;flex-direction:column;align-items:center;justify-content:center;background-color:var(--primary-color);.images{display:flex;max-width:1200px;overflow-x:scroll;a{display:inline-flex;position:relative;&:after{content:attr(data-text);position:absolute;bottom:0;margin:0;background-color:rgba(0,0,0,0.6);color:white;padding:8px 16px;opacity:0.2;transition:all ease 300ms;width:100%;}&:hover{&:after{opacity:1;}}}}img{object-fit:cover;}"]);

/***/ })

})
//# sourceMappingURL=index.js.abb7ce423b381b499043.hot-update.js.map