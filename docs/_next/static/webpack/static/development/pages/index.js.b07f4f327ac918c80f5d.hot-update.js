...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  return __jsx(Container, {
    ...
    "data-glightbox": "Photo shared by \uD83C\uDF40Thaynara Oliveira \uD83C\uDF40 on April 06, 2020 tagging @andreantunesvieira. A imagem pode conter: 1 pessoa, selfie e close-up",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 15,
...
})(["display:flex;flex-direction:column;align-items:center;justify-content:center;.images{display:flex;max-width:1200px;a{display:inline-flex;position:relative;p{position:absolute;bottom:0;margin:0;min-height:50px;background-color:rgba(0,0,0,0.6);color:white;padding:8px 16px;opacity:0.2;transition:all ease 300ms;}&:hover{p{opacity:1;}}}}img{object-fit:cover;}"]);

/***/ })

})
//# sourceMappingURL=index.js.b07f4f327ac918c80f5d.hot-update.js.map