...
})(["display:flex;flex-direction:column;align-items:center;justify-content:center;background-color:black;background-image:url(/boca.webp);min-height:600px;background-position:center center;background-size:cover;div{flex-grow:1;display:flex;align-items:center;justify-content:center;}.disclaimer{padding:48px;background-color:rgba(255,255,255,0.6);font-weight:bold;font-size:32px;border-radius:8px;background:-webkit-linear-gradient(90deg,var(--primary-color-01),var(--secondary-color-01));background:linear-gradient(90deg,var(--primary-color),var(--secondary-color));color:white}"]);

/***/ })

})
//# sourceMappingURL=index.js.e40c2ec46bd1d482c8fc.hot-update.js.map